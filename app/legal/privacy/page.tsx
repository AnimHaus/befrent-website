...
const POLICY_SECTIONS = [
  {
    ...
    icon: <Eye size={20} />,
    content: "We collect precise GPS location data, biometric facial mapping for identity verification, and device metadata. This is non-negotiable for the operation of the Befrent protocol. Location tracking is active during scheduled date windows to enforce geofencing and safety escalations."
  },
  {
    id: "02",
  ...
  },
  {
    ...
    icon: <Bell size={20} />,
    content: "In the event of an ignored 20-minute safety window, your last known GPS coordinates and profile data will be shared with local law enforcement. By using Befrent, you provide irrevocable consent for this data disclosure in high-risk scenarios."
  },
  {
    id: "05",
    title: "Financial Security",
    icon: <Lock size={20} />,
    content: "Payment details are handled through encrypted gateways. Befrent does not store full credit card numbers but maintains transaction logs for hourly extensions and security deposit releases."
  }
];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <h3 className="text-2xl sm:text-3xl font-black uppercase italic tracking-tighter max-w-xl mx-auto">
            By accessing the Befrent network, you acknowledge the absolute nature of these protocols.
          </h3>
